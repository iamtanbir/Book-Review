...
const Wishlist = () => {
  ...
  const handleWishListFilter = (filter) => {
    ...
    setDisplayWishList(sortedWishList);
  };
    ...
    <div className="container mx-auto px-4 lg:px-0">
      ...
      <div className="flex justify-center items-center py-8">
        <div className="dropdown">
          ...
          >
            <li>
              <a onClick={() => handleWishListFilter("all")}>All</a>
            </li>
            <li>
              <a onClick={() => handleWishListFilter("rating")}>Rating</a>
            </li>
            <li>
              <a onClick={() => handleWishListFilter("totalPages")}>
                Number of pages
              </a>
            </li>
            <li>
              <a onClick={() => handleWishListFilter("yearOfPublishing")}>
                Published year
              </a>
            </li>
          </ul>
